...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">ANNEX C</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body table-responsive">
                <h2></h2> 
                <!--FORM 1-->
                <form id="schoolForm" action="<?php echo base_url('Jb_coa/school_ppe_annex_c'); ?>" method="post">
...
<!-- FORM 2 -->
<form id="districtForm" action="<?php echo base_url('Jb_coa/school_ppe_annex_c_district'); ?>" method="post" style="display:none;">
