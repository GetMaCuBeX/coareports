    ...
    <body>
        <div class="page-container">
            ...
            <?php if (!empty($rs)): ?>
                ...
                <p class="table-title" style="margin-bottom: 5px; margin-left: 1px; font-size: 10px; text-align: left; vertical-align: middle; ">PPE - ANNEX B</p>
                <table>
                    ...
                    <?php foreach ($rs as $row): ?>
                        ...
                        <?php if ($row->_R2 == 1) { ?>
                            <tr>
                                <td colspan="9" style="color: red;
                                    " class="no-outline"><strong><?= strtoupper($row->GROUP_NAME) ?></strong></td>
                            </tr>
                        <?php } ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="maxwidth-description"><?= ($row->DESCRIPTION) ?></td>
