        ...
        <div class="page-title-box">
            ...
            if (!empty($rs)) {
                foreach ($rs as $school) {
                    echo '<h4 class="page-title">' . strtoupper($school->DISTRICT) . '</h4>';
                    echo '<br>';
                    echo '<h4 class="page-title">' . $school->SCHOOLID . ' - ' . strtoupper($school->SCHOOLNAME) . '</h4>';
                    break; // Exit after the first iteration
                }
            } else {
                echo '<h4 class="page-title">No school found.</h4>';
            }
            ?>
...
<button onclick="exportTableToExcel()" class='btn btn-warning waves-effect waves-light'>Export to Excel</button>
<!-- Back Button -->
<button type="button" onclick="window.history.back();" class='btn btn-warning waves-effect waves-light'>Back</button>
...
//                }
                if ($row->_R2 == 1) { 
                    echo '<tr>';
                    echo '<td colspan="18" style="border: none;"><h4>' . strtoupper($row->GROUP_NAME) . '</h4></td>';
                    echo '</tr>';
                }
                echo '<tr>';
